                ...
                <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
                    ...
                    <div className="grid gap-3">
                        {customOrder.items.map((item, index) => (
                            <Card
                                key={item.title}
                                className="rounded-md border-[#ead0d4] bg-white/65 py-4 shadow-none ring-[#ead0d4] transition-all duration-200 hover:-translate-y-1 hover:border-[#d88c98] hover:bg-white sm:hover:shadow-md"
                            >
